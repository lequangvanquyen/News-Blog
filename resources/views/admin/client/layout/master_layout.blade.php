...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="{{asset('client/images_admin/favicon.ico')}}">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon57.png')}}" sizes="57x57">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon72.png')}}" sizes="72x72">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon76.png')}}" sizes="76x76">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon114.png')}}" sizes="114x114">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon120.png')}}" sizes="120x120">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon144.png')}}" sizes="144x144">
        <link rel="apple-touch-icon" href="{{asset('client/images_admin/icon152.png')}}" sizes="152x152">
        <!-- END Icons -->

        <!-- Stylesheets -->
        <!-- Bootstrap is included in its original form, unaltered -->
        <link rel="stylesheet" href="{{asset('client/css_admin/bootstrap.css')}}">

        <!-- Related styles of various javascript plugins -->
        <link rel="stylesheet" href="{{asset('client/css_admin/plugins.css')}}">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="{{asset('client/css_admin/main.css')}}">

        <!-- Load a specific file here from css/themes/ folder to alter the default theme of the template -->

        <!-- The themes stylesheet of this template (for using specific theme color in individual elements - must included last) -->
        <link rel="stylesheet" href="{{asset('client/css_admin/themes.css')}}">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) & Respond.js (Enable responsive CSS code on browsers that don't support it, eg IE8) -->
        <script src="{{asset('client/js_admin/vendor/modernizr-respond.min.js')}}"></script>
    </head>
    ...
    @include('admin.client.partials.footer')
        ...
        <!-- Bootstrap.js -->
        <script src="{{asset('client/js_admin/vendor/bootstrap.min.js')}}"></script>

        <!-- Jquery plugins and custom javascript code -->
        <script src="{{asset('client/js_admin/plugins.js')}}"></script>
        <script src="{{asset('client/js_admin/main.js')}}"></script>
        <script src="{{asset('client/js_admin/ckeditor/ckeditor.js')}}"></script>
